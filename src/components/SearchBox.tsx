...
const stylesContainer = `border-2 flex h-[70px] items-center px-[25px] rounded-[10px] shadow-[0_4px_4px_rgba(0,0,0,0.25)] text-[20px] w-full
hover:scale-[100.2%]
sm:text-[24px]`
const stylesInput = `bg-transparent h-full w-full
placeholder:text-default-darkGray
dark:placeholder:text-default-lightGray`
const stylesIcon = `cursor-pointer fill-default-black h-[28px] ml-2 w-[28px]
hover:scale-[102%]
